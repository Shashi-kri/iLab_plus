...
# Load trained model
model = tf.keras.models.load_model(r"iLab\dataset\Eyelid_Training\Eyelid_Classifier.keras")

# Class names (must match train_gen.class_indices order)
class_names = ['Eyelid', 'Normal Eye']

# Path to image you want to test
img_path = r"iLab\dataset\Eyelid_Training\test\Normal Eye\image_63.jpg"  # <- change as needed
